...
type ProductCardTwoGridVariant = Exclude<GridVariant, "one-large-right-three-stacked-left" | "items-top-row-full-width-bottom" | "full-width-top-items-bottom-row" | "one-large-left-three-stacked-right">;
