...
const SplitAbout = ({
  ...
  const mediaContent = (
    <div className={cls("w-full md:w-6/10 2xl:w-7/10 rounded-theme-capped card md:relative p-4", mediaBadge ? "overflow-visible" : "overflow-hidden", mediaWrapperClassName)}>
